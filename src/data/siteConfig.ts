...
export const aboutContent = {
  ...
  bio: [
    "I help state and local governments provide better public services. As a consultant and product developer, I combine technical skills with policy expertise to solve real problems, whether that means building custom software, analyzing complex data, or advising on strategic initiatives. In addition to government agencies, current and former clients include nonprofits and for-profit businesses.",
